...
#define FLAG_DEFEATED_RESHIRAM               0x1DE // (No Longer Unused) Unused Flag
#define FLAG_HIDE_RESHIRAM                   0x1DF // (No Longer Unused) Unused Flag
#define FLAG_LANDMARK_SPEAR_PILLAR           0x1E0 // Unused Flag
