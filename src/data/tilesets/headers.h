...
const struct Tileset gTileset_kanto_sevii_islands_45 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_kanto_sevii_islands_45,
    .palettes = gTilesetPalettes_kanto_sevii_islands_45,
    .metatiles = gMetatiles_kanto_sevii_islands_45,
    .metatileAttributes = gMetatileAttributes_kanto_sevii_islands_45,
    .callback = NULL,
};
const struct Tileset gTileset_Kanto_Vermillion_City =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Kanto_Vermillion_City,
    .palettes = gTilesetPalettes_Kanto_Vermillion_City,
    .metatiles = gMetatiles_Kanto_Vermillion_City,
    .metatileAttributes = gMetatileAttributes_Kanto_Vermillion_City,
    .callback = NULL,
};
